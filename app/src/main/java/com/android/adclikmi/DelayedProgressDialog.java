...
public class DelayedProgressDialog extends DialogFragment {
    private static final int DELAY_MILLISECOND = 100;
    private static final int MINIMUM_SHOW_DURATION_MILLISECOND = 200;
    private static final int PROGRESS_CONTENT_SIZE_DP = 80;

    private ProgressBar mProgressBar;
    private TextView num;
    private boolean startedShowing;
    private int mode, max =100, cur;
    ...
    public void onStart() {
        ...
        num= getDialog().findViewById(R.id.num);*/
