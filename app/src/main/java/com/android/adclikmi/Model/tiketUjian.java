...
public class tiketUjian implements Serializable {
    ...
    public tiketUjian(String noTiket, Date tglTrans, String NPM, String nama, int kelas, int jnsTiket, int stat, String jenis, String thnSem, Date tglAwal, Date tglAkhir, String keterangan, ArrayList<mataKuliah> matkul) {
